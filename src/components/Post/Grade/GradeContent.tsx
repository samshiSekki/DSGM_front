            ...
            {num == 0 ? (
              <>
                <div style={{ whiteSpace: "pre-line" }}>
                  ...
                  <MobileInputDiv
                    style={{ width: "170px" }}
                    onChange={(e) => changeInputValue(e, "gradeContent0_1")}
                  ></MobileInputDiv>
                  수업에서{" "}
                  <MobileInputDiv
                    style={{ width: "170px" }}
                    onChange={(e) => changeInputValue(e, "gradeContent0_2")}
                  ></MobileInputDiv>
                  {"부분에 대해 저는 최선을 \n다했습니다. "}
                </div>
                {state1 == false ? (
                  ...
                  <>
                    ...
                    <MobileTextArea
                      ...
                      onChange={(e) =>
                        changeInputValue(e, "gradeContent0_plus1")
                      }
                    ></MobileTextArea>
                  </>
                )}
                ...
                {state2 == false ? (
                  ...
                  <>
                    ...
                    <MobileTextArea
                      ...
                      onChange={(e) =>
                        changeInputValue(e, "gradeContent0_plus2")
                      }
                    ></MobileTextArea>
                  </>
                )}
                <div style={{ whiteSpace: "pre-line" }}>
                  {
                    "어떤 부분이 부족하여 이런 성적을 받았는지 여쭙고 싶어\n 메일을 작성하게 되었습니다."
                  }{" "}
                </div>
                {state3 == false ? (
                  ...
                  <>
                    ...
                    <MobileTextArea
                      ...
                      onChange={(e) =>
                        changeInputValue(e, "gradeContent0_plus3")
                      }
                    ></MobileTextArea>
                  </>
                )}
                <div style={{ whiteSpace: "pre-line" }}>
                  {
                    "교수님의 피드백을 바탕으로 이후 부족한 점을 보완하고자 하니, \n바쁘시겠지만 꼭 한 번 다시 검토해주시면 감사하겠습니다."
                  }
                </div>
                {state4 == false ? (
                  ...
                  <>
                    ...
                    <MobileTextArea
                      ...
                      onChange={(e) =>
                        changeInputValue(e, "gradeContent0_plus4")
                      }
                    ></MobileTextArea>
                  </>
                )}
              ...
              <>
                <div style={{ whiteSpace: "pre-line" }}>
                  {
                    "다름이 아니라 각 항목에 대한 취득 점수 및 상세 성적을 알 수 있을까 싶어\n 메일을 보내게 되었습니다."
                  }{" "}
                </div>
                {state1 == false ? (
                  <MobileButtonStyled onClick={() => setState1(true)}>
                  ...
                  <>
                    ...
                    <MobileTextArea
                      ...
                      onInput={() => handleResize(1)}
                      onChange={(e) =>
                        changeInputValue(e, "gradeContent1_plus1")
                      }
                    ></MobileTextArea>
                  </>
                )}
                <div style={{ whiteSpace: "pre-line" }}>
                  {
                    "과제와 시험 모두 나름대로 열심히 준비했는데, \n예상한 결과보다는 아쉬운 결과에 문의를 드리게 되었습니다."
                  }{" "}
                </div>
                {state2 == false ? (
                  <MobileButtonStyled onClick={() => setState2(true)}>
                  ...
                  <>
                    ...
                    <MobileTextArea
                      ...
                      onInput={() => handleResize(2)}
                      onChange={(e) =>
                        changeInputValue(e, "gradeContent1_plus2")
                      }
                    ></MobileTextArea>
                  </>
                )}
                <div style={{ whiteSpace: "pre-line" }}>
                  {
                    "제가 어떤 부분에서 부족했고, 앞으로 어떠한 부분을 보완하는 것이 좋을지 \n의견을 여쭙고 싶어 실례를 무릅쓰고 메일 드립니다."
                  }
                </div>
                {state3 == false ? (
                  <MobileButtonStyled onClick={() => setState3(true)}>
                  ...
                  <>
                    ...
                    <MobileTextArea
                      ...
                      onInput={() => handleResize(3)}
                      onChange={(e) =>
                        changeInputValue(e, "gradeContent1_plus3")
                      }
                    ></MobileTextArea>
                  </>
                )}
                <div>
                  제가 어떤 부분이 부족했는지 알려주시면 학업에 참고하여
                  보완하고 싶습니다.
                </div>
                {state4 == false ? (
                  <MobileButtonStyled onClick={() => setState4(true)}>
                  ...
                  <>
                    ...
                    <MobileTextArea
                      ...
                      onInput={() => handleResize(4)}
                      onChange={(e) =>
                        changeInputValue(e, "gradeContent1_plus4")
                      }
                    ></MobileTextArea>
                  </>
                )}
      ...
      {isIPad13 || isBrowser ? (
        <div>
          {num == 0 ? (
              ...
              {state1 == false ? (
                ...
                <>
                  ...
                  <TextArea
                    ref={textRef1}
                    onInput={() => handleResize(1)}
                    onChange={(e) => changeInputValue(e, "gradeContent0_plus1")}
                  ></TextArea>
                </>
              )}
              <div>
              ...
              {state2 == false ? (
                ...
                <>
                  ...
                  <TextArea
                    ref={textRef2}
                    onInput={() => handleResize(2)}
                    onChange={(e) => changeInputValue(e, "gradeContent0_plus2")}
                  ></TextArea>
                </>
              )}
              <div>
                어떤 부분이 부족하여 이런 성적을 받았는지 여쭙고 싶어 메일을
                작성하게 되었습니다.{" "}
              </div>
              {state3 == false ? (
                ...
                <>
                  ...
                  <TextArea
                    ref={textRef3}
                    onInput={() => handleResize(3)}
                    onChange={(e) => changeInputValue(e, "gradeContent0_plus3")}
                  ></TextArea>
                </>
              )}
              <div>
              ...
              {state4 == false ? (
                ...
                <>
                  ...
                  <TextArea
                    ref={textRef4}
                    onInput={() => handleResize(4)}
                    onChange={(e) => changeInputValue(e, "gradeContent0_plus4")}
                  ></TextArea>
                </>
              )}
            </>
            ...
            <>
              <div>
                다름이 아니라 각 항목에 대한 취득 점수 및 상세 성적을 알 수
                있을까 싶어 메일을 보내게 되었습니다.{" "}
              </div>
              {state1 == false ? (
                <ButtonStyled onClick={() => setState1(true)}>+</ButtonStyled>
              ) : (
                <>
                  ...
                  <TextArea
                    ref={textRef1}
                    onInput={() => handleResize(1)}
                    onChange={(e) => changeInputValue(e, "gradeContent1_plus1")}
                  ></TextArea>
                </>
              )}
              <div>
                과제와 시험 모두 나름대로 열심히 준비했는데, 예상한 결과보다는
                아쉬운 결과에 문의를 드리게 되었습니다.{" "}
              </div>
              {state2 == false ? (
                <ButtonStyled onClick={() => setState2(true)}>+</ButtonStyled>
              ) : (
                <>
                  ...
                  <TextArea
                    ref={textRef2}
                    onInput={() => handleResize(2)}
                    onChange={(e) => changeInputValue(e, "gradeContent1_plus2")}
                  ></TextArea>
                </>
              )}
              <div>
                제가 어떤 부분에서 부족했고, 앞으로 어떠한 부분을 보완하는 것이
                좋을지 의견을 여쭙고 싶어 실례를 무릅쓰고 메일 드립니다.
              </div>
              {state3 == false ? (
                <ButtonStyled onClick={() => setState3(true)}>+</ButtonStyled>
              ) : (
                <>
                  ...
                  <TextArea
                    ref={textRef3}
                    onInput={() => handleResize(3)}
                    onChange={(e) => changeInputValue(e, "gradeContent1_plus3")}
                  ></TextArea>
                </>
              )}
              <div>
                제가 어떤 부분이 부족했는지 알려주시면 학업에 참고하여 보완하고
                싶습니다.
              </div>
              {state4 == false ? (
                <ButtonStyled onClick={() => setState4(true)}>+</ButtonStyled>
                ...
                <>
                  ...
                  <TextArea
                    ref={textRef4}
                    onInput={() => handleResize(4)}
                    onChange={(e) => changeInputValue(e, "gradeContent1_plus4")}
                  ></TextArea>
                </>
              )}
            </>
