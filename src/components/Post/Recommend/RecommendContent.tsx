...
const RecommendContent = ({ num, setNum }: NumberProps) => {
  ...
  useEffect(() => {
    ...
    dispatch({
      type: "change",
      payload: { changeData: num, variableType: "recommendState" },
    });
  }, [num]);
          ...
          {num == 0 ? (
            <>
              <div>
                다름이 아니라,{" "}
                <InputDiv
                  onChange={(e) => changeInputValue(e, "recommendContent0_1")}
                ></InputDiv>
                에 지원하고자 하는데, 교수님의 추천서가 필요하다고 합니다.
              </div>
              {state1 == false ? (
                ...
                <>
                  ...
                  <TextArea
                    ...
                    onChange={(e) =>
                      changeInputValue(e, "recommendContent0_plus1")
                    }
                  ></TextArea>
                </>
              )}
              <div>
                교수님의{" "}
                <InputDiv
                  onChange={(e) => changeInputValue(e, "recommendContent0_2")}
                ></InputDiv>
                강의를 통해
                <InputDiv
                  onChange={(e) => changeInputValue(e, "recommendContent0_3")}
                ></InputDiv>
                에 대한 관심을 발견한 것은{" "}
                <InputDiv
                  onChange={(e) => changeInputValue(e, "recommendContent0_4")}
                ></InputDiv>
                을 선택하는 동기가 되었습니다.
              </div>
              {state2 == false ? (
                ...
                <>
                  ...
                  <TextArea
                    ...
                    onChange={(e) =>
                      changeInputValue(e, "recommendContent0_plus2")
                    }
                  ></TextArea>
                </>
              )}
              <div>
                따라서 교수님께{" "}
                <InputDiv
                  onChange={(e) => changeInputValue(e, "recommendContent0_5")}
                ></InputDiv>
                지원을 위한 추천서를 부탁드리고자 메일을 드립니다.
              </div>
              {state4 == false ? (
                ...
                <>
                  ...
                  <TextArea
                    ...
                    onChange={(e) =>
                      changeInputValue(e, "recommendContent0_plus3")
                    }
                  ></TextArea>
                </>
              )}
              <div>
                교수님의 승낙 이후에 추천서 일정 및 양식, 저에 대한 정보 등을
                다시 첨부해드리고 방문 상담 일정을 잡고 싶습니다.
              </div>
              {state5 == false ? (
                ...
                <>
                  ...
                  <TextArea
                    ...
                    onChange={(e) =>
                      changeInputValue(e, "recommendContent0_plus4")
                    }
                  ></TextArea>
                </>
              )}
