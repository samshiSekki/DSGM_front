...
const Undergraduate = ({num,setNum}:NumberProps) => {
    ...
    return (
        ...
        {num == 0 ?
        <>
        <div>졸업 후의 진로에 대해 고민하던 중 교수님의 <InputDiv onChange={(e)=>changeInputValue(e, 'billnutContent0_1')}></InputDiv>부분에 특히 관심이 가서 해당 분야로의 진학이나 진로에 대한 교수님의 조언을 듣고 싶습니다.</div>
        ...
        <div>하지만 잠깐이라도 시간을 내주신다면 <InputDiv onChange={(e)=>changeInputValue(e, 'billnutContent0_2')}></InputDiv> 진학에 대한 말씀 뿐만 아니라 진로에 관한 어떤 조언이라도 감사하게 새겨듣도록 하겠습니다.</div>
        ...
        <div>제 전화번호는 <InputDiv onChange={(e)=>changeInputValue(e, 'billnutContent0_4')}></InputDiv>입니다.</div>
        ...
        <div>저는 <InputDiv onChange={(e)=>changeInputValue(e, 'billnutContent0_4')}></InputDiv>에 면담이 가능합니다.</div>
        ...
        : 
        <>
        <div>교수님의 <InputDiv onChange={(e)=>changeInputValue(e, 'billnutContent1_1')}></InputDiv>에 <InputDiv onChange={(e)=>changeInputValue(e, 'billnutContent1_1')}></InputDiv>과정으로 진학을 희망해 메일 드립니다.</div>
        {state1 == false ? <ButtonStyled onClick={()=>setState1(true)}>+</ButtonStyled> :
        ...
        <div>저는 <InputDiv onChange={(e)=>changeInputValue(e, 'billnutContent1_1')}></InputDiv>학과에 재학하며, <InputDiv onChange={(e)=>changeInputValue(e, 'billnutContent1_1')}></InputDiv>를 공부하던 도중 <InputDiv onChange={(e)=>changeInputValue(e, 'billnutContent1_1')}></InputDiv>를 추가로 더 배우며, <InputDiv onChange={(e)=>changeInputValue(e, 'billnutContent1_1')}></InputDiv>를 하고자하는 꿈이 생겼습니다.</div>
        {state2 == false ? <ButtonStyled onClick={()=>setState2(true)}>+</ButtonStyled> :
        ...
        <div>특히 제게 흥미를 주신 <InputDiv onChange={(e)=>changeInputValue(e, 'billnutContent1_1')}></InputDiv>교수님께 더 배우고 싶었고, 이에 <InputDiv onChange={(e)=>changeInputValue(e, 'billnutContent1_1')}></InputDiv>를 연구하고자 진학을 희망하게 되었습니다.</div>
        {state3 == false ? <ButtonStyled onClick={()=>setState3(true)}>+</ButtonStyled> :
        ...
        <div><InputDiv onChange={(e)=>changeInputValue(e, 'billnutContent1_1')}></InputDiv>년 <InputDiv onChange={(e)=>changeInputValue(e, 'billnutContent1_1')}></InputDiv> TO가 있는지 궁금합니다.</div>
        {state4 == false ? <ButtonStyled onClick={()=>setState4(true)}>+</ButtonStyled> :
        ...
        <div>또한 입학하기 전 제가 특히 부족한 부분들에 대해 조언을 받을 수 있다면 <InputDiv onChange={(e)=>changeInputValue(e, 'billnutContent1_1')}></InputDiv> 과정에 지원하는 데 있어 많은 도움이 될거라는 생각에 이렇게 메일을 보내게 되었습니다.</div>
        {state5 == false ? <ButtonStyled onClick={()=>setState5(true)}>+</ButtonStyled> :
