...
function GraduateSchool(props: any) {
  ...
  function copyBtnClickHandler(){
    ...
    <div className='buttonContainer'>
    {
      ...
      <div onClick={()=>{window.location.replace("/graduateschool")}} className='functionBtn'>Clear</div>
    ...
    <MobileView>
      <ButtonContainerMobile>
        <MobileButtonFlex>
          ...
          <FunctionBtnMobile onClick={()=>{window.location.replace("/graduateschool")}}>Clear</FunctionBtnMobile>
